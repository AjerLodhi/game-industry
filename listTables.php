<!-- listTables.php
     A PHP script to access all tables from my database
     through MySQL
     -->
<html>
<head>
<title> Access the tables with MySQL </title>
</head>
<body>
<?php
...
echo"<font size = 12><b>ALL TABLES</b></font>"; 
echo"<br>-----------------------------------------------------------<br>";

$query = "DESC VideoGameDevelopers";
