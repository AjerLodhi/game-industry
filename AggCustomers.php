<!-- AggCustomers.php
     A PHP script to access the Customer table from my database
     through MySQL
     -->
<html>
<head>
<title> Access the Customer table with MySQL </title>
</head>
<body>
<?php
...
echo"<font size = 12><b>Customers Aggregate</b></font>"; 
echo"<br>-------------------------------------------------------------------------------------<br>";

$query = "SELECT COUNT(Age) FROM Customer";
...
$query = "SELECT MIN(Age) FROM Customer";
...
$query = "SELECT MAX(Age) FROM Customer";
...
$query = "SELECT SUM(Age) FROM Customer";
