<!-- join_VGP_VG.php
     A PHP script to access the VideoGamePublisher and VideoGames table from my database
     through MySQL
     -->
<html>
<head>
<title> Access the VideoGamePublisher and VideoGames table with MySQL </title>
</head>
<body>
<?php

echo"<font size = 12><b>VideoGamePublisher+VideoGames Table</b></font>"; 
echo"<br>---------------------------------------------------------------------------------------------------------------------------------------------------------------<br>";
...
$query = "SELECT * FROM VideoGamePublisher p JOIN VideoGames v ON p.Pname = v.Pname LIMIT 50";
